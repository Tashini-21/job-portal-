...
import main_logon from "./main_logon.png";
import logo_n from "./logo_n.png";
...
import workify_logo from './workify_logo.jpg'
import Hemas_logo from './Hemas_logo.png'
import IFS_logo from './IFS_logo.png'
import Nestle_logo from './Nestle_logo.png'
import virtusa_logo from './virtusa_logo.png'
import w_logo from './w_logo.png'
import def_logo from './def_logo.jpg'
...
export const manageJobsData = [
    { _id: 1, title: "Full Stack Developer", date: 1729102298497, location: "Nugegoda", applicants: 20 },
    { _id: 2, title: "Data Scientist", date: 1729102298497, location: "Rathmalana", applicants: 15 },
    { _id: 3, title: "Marketing Manager", date: 1729102298497, location: "Homagama", applicants: 2 },
    { _id: 4, title: "UI/UX Designer", date: 1729102298497, location: "Panadura", applicants: 25 }
];
...
export const viewApplicationsPageData = [
    { _id: 1, name: "Richard Sanford", jobTitle: "Full Stack Developer", location: "Nugegoda", imgSrc: profile_img },
    { _id: 2, name: "Enrique Murphy", jobTitle: "Data Scientist", location: "Narahenpita", imgSrc: profile_img },
    { _id: 3, name: "Alison Powell", jobTitle: "Marketing Manager", location: "Rathmalana", imgSrc: profile_img },
    { _id: 4, name: "Richard Sanford", jobTitle: "UI/UX Designer", location: "Kottawa", imgSrc: profile_img },
    { _id: 5, name: "Enrique Murphy", jobTitle: "Full Stack Developer", location: "Homagama", imgSrc: profile_img },
    { _id: 6, name: "Alison Powell", jobTitle: "Data Scientist", location: "Panadura", imgSrc: profile_img },
    { _id: 7, name: "Richard Sanford", jobTitle: "Marketing Manager", location: "Kirulapana", imgSrc: profile_img },
];
...
export const jobsData = [{
    ...
    },
    {
        ...
        description: `
        <p>We are seeking a qualified and dedicated Pharmacist to join our healthcare team. The ideal candidate will be responsible for dispensing medications, counseling patients on correct usage, and ensuring compliance with legal and medical guidelines.</p>
        <h2><strong>Key Responsibilities</strong></h2>
        <ol>
            <li>Accurately dispense prescription and over-the-counter medications.</li>
            <li>Review prescriptions to ensure accuracy and check for potential drug interactions.</li>
            <li>Provide patient counseling on dosage, side effects, and medication schedules..</li>
            <li>Maintain up-to-date knowledge of pharmaceutical products and practices.</li>
            <li>Ensure compliance with health and safety regulations and pharmacy laws.</li>
        </ol>
        <h2><strong>Skills Required</strong></h2>
        <ol>
            <li>Attention to detail</li>
            <liStrong knowledge of chemistry and biology</li>
            <li>Communication and counseling skills</li>
            <li>Experience with container orchestration tools like Kubernetes.</li>
            <liEthics and confidentiality.</li>
        </ol>`,
        salary: 102000,
        date: 1729681667114,
    ...
    },
    {
        ...
        description: `
        <p>We are looking for a dedicated and compassionate Physiotherapist to join our rehabilitation team. The ideal candidate will be responsible for evaluating, diagnosing, and treating patients with physical disorders, injuries, or disabilities to help them improve mobility and quality of life.</p>
        <h2><strong>Key Responsibilities</strong></h2>
        <ol>
            <li>Assess patients physical conditions and medical histories.</li>
            <li>Create and implement individualized treatment plans based on physical therapy goals.</li>
            <li>Use physical exercises, manual therapy, electrotherapy, and other techniques to treat patients.</li>
            <li>Monitor and record progress throughout the rehabilitation process.</li>
            <li>Educate patients and caregivers on preventive care and home exercises.</li>
        </ol>
        <h2><strong>Skills Required</strong></h2>
        <ol>
    ...
    },
    {
        ...
        description: `
        <p>We are seeking a dedicated and skilled Engineer to join our dynamic team. The ideal candidate will have a solid background in either Mechanicalengineering, with a passion for solving complex problems and driving innovative solutions. This is a great opportunity to work on cutting-edge projects and make a significant impact in the industry.</p>
        <h2><strong>Key Responsibilities</strong></h2>
        <ol>
            <li>Design, develop, and implement engineering solutions for various projects.</li>
            <li>Analyze and troubleshoot technical issues, providing innovative solutions</li>
            <li>Collaborate with cross-functional teams, including design, production, and testing.</li>
            <li>Prepare technical documentation, reports, and project plans.</li>
            <li>Perform detailed engineering calculations, simulations, and analyses.</li>
        </ol>
        <h2><strong>Skills Required</strong></h2>
        <ol>
            <li>Strong understanding of engineering principles, methodologies, and best practices.</li>
            <li>Excellent problem-solving and critical thinking skills.</li>
